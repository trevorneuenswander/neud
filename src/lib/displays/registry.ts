...
export function buildPylonViewerPath(baseUrl: string, pollMs = 1000): string {
...
export function buildNewBidDisplayV1ViewerPath(baseUrl: string, pollMs = 1000): string {
  const origin = baseUrl.replace(/\/$/, "");
...
export function buildNewTickerV1ViewerPath(baseUrl: string, pollMs = 1000): string {
  const origin = baseUrl.replace(/\/$/, "");
