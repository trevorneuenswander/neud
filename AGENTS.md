...
**Latest published release:** v0.2.0 (v0.2.1 release in progress). **Current version:** v0.2.1 (canonical `package.json` version). See [docs/release-milestones.md](./docs/release-milestones.md).

The **current release milestone** remains Windows x64 packaging, bundled Puppeteer Chrome, installation validation, and automatic updates for v0.2.1. See [docs/windows-packaging.md](./docs/windows-packaging.md).
