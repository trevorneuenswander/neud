...
export type StreamTickerLogoFailureStage =
  | "local_asset_reference_invalid"
  | "asset_not_packaged"
  | "asset_not_synced"
  | "hosted_asset_url_missing"
  | "hosted_asset_route_failed"
  | "relative_url_without_base"
  | "sanitizer_removed_source"
  | "iframe_request_failed"
